...
urlpatterns = [
    ...
    path('update_payment_method/<int:id>', views.update_payment_method, name='update_payment_method'),
    ...
    path('orders/<int:year>/<int:month>/<int:day>/', views.orders_by_day, name='orders_by_day'),
