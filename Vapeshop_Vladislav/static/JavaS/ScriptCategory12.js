const menuButton = document.querySelector('.collapsible');
const menuItems = document.querySelector('.content');

menuButton.addEventListener('click', () => {
    const isMenuVisible = menuItems.style.display === 'initial';
    menuItems.style.display = isMenuVisible ? 'none' : 'initial';
});
