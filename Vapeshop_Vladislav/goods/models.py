...
class Goods(models.Model):
    taste = models.CharField(max_length=100, verbose_name='Вкус/модель товара', help_text='Укажите вкус или модель товара', null=True)
    description = models.TextField(verbose_name="Описание товара", help_text="Введите описание товара", null=True)
    ...
    image = models.FileField(upload_to='images/', verbose_name='Изображение товара', help_text='Выберите изображение товара', null=True)
...
class Line(models.Model):
    line = models.CharField(max_length=100, verbose_name='Название линейки', help_text='Введите название линейки', default='', blank=True)
    brand = models.CharField(max_length=100, verbose_name='Название бренда', help_text='Введите название бренда', null=True, default='')
    def __str__(self):
